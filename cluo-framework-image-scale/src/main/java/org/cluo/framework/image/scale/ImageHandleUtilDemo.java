...
public class ImageHandleUtilDemo {
    public static void main(String[] args) throws IOException, InterruptedException {
         ...
         * 本方法将在原目录下会生成三个图片
         * 1. TestImage_thumb.jpg 原图片清晰度 与原图分辨率相同 使用无损压缩处理
         * 2. TestImage_sd.jpg 普通图清晰度 大小在90-120k之间的图片 （若原图尺寸小于比例缩小后尺寸则此图片分辨率与原图相同）
         * 3. TestImage_mini.jpg 缩略图清晰度 大小在10k左右 模糊缩略图可用作小图展示
         */
